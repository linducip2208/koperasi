...
CREATE TABLE `anggota` (
  ...
  `nomor_anggota` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nik` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `kk_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kategori` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'biasa',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aktif',
  `tanggal_masuk` date DEFAULT NULL,
  `tanggal_keluar` date DEFAULT NULL,
  `alasan_keluar` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `asset` (
  ...
  `metode_susut` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'garis_lurus',
...
CREATE TABLE `asuransi_polis` (
  ...
  `anggota_id` bigint unsigned NOT NULL,
  `nomor_polis` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `asuransi_produk` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `penanggung` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cabang` (
  ...
  `telp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipe` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kantor_pusat',
  `aktif` tinyint(1) NOT NULL DEFAULT '1',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `karyawan` (
  ...
  `npwp` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_bpjs_kesehatan` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_bpjs_naker` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rekening_bank` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `kas` (
  ...
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipe` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kas',
  `nomor_rekening` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `numbering_setting` (
  ...
  `format` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '{prefix}{ymd}{seq:5}',
...
CREATE TABLE `payment_providers` (
  ...
  `session_endpoint` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pinjaman` (
  ...
  `anggota_id` bigint unsigned NOT NULL,
  `produk_id` bigint unsigned NOT NULL,
  `nomor_akad` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tanggal_pengajuan` date NOT NULL,
  ...
  `analisa_kredit` text COLLATE utf8mb4_unicode_ci,
  `survey_data` json DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pengajuan',
  `kolektabilitas` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'lancar',
...
CREATE TABLE `pinjaman_approval` (
  ...
  `jabatan` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `keputusan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `catatan` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `pinjaman_jadwal` (
  ...
  `tanggal_bayar` date DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'belum_jatuh_tempo',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pinjaman_pembayaran` (
  ...
  `nomor` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tanggal` date NOT NULL,
  `jenis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'angsuran',
...
CREATE TABLE `produk_pinjaman` (
  ...
  `kode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'produktif',
  `akad_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'konvensional',
  `metode_perhitungan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `produk_simpanan` (
  ...
  `metode_bunga` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nisbah_anggota` decimal(5,2) NOT NULL DEFAULT '0.00',
  `nisbah_koperasi` decimal(5,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `rat_kehadiran` (
  ...
  `metode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `shu_distribusi` (
  ...
  `metode_distribusi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'simpanan_sukarela',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'belum_dibagikan',
...
CREATE TABLE `tagihan_master` (
  ...
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nominal` bigint NOT NULL,
  `siklus` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bulanan',
  `coa_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `tenants` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `badan_hukum` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nik_koperasi` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `operation_mode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'konvensional',
  `mata_uang` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'IDR',
...
CREATE TABLE `toko_barang` (
  ...
  `foto_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metode_hpp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'average',
...
CREATE TABLE `toko_penjualan` (
  ...
  `metode_bayar` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
  `kas_id` bigint unsigned DEFAULT NULL,
  `simpanan_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `unit_jasa_layanan` (
  ...
  `satuan_tarif` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `aktif` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
